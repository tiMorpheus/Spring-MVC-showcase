package github.morpheus.dataexam.test.config;
...
@ComponentScan("github.tiMorpheus.dataexam")
public class TestDataBaseConfig {
    ...
    private static final String PROPERTY_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN = "github.tiMorpheus.dataexam.entity";
